      ...
      <div className="glass-card rounded-xl w-full max-w-6xl mx-4 max-h-[90vh] overflow-hidden">
        ...
        <div className="flex border-b border-gray-200">
          <button
            ...
            className={`px-6 py-4 font-medium transition-colors ${
              activeTab === 'items'
                ? 'text-topol-600 border-b-2 border-topol-600'
        ...
        >
            ...
            <div>
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  className="flex items-center space-x-2 space-x-reverse bg-topol-500 text-white px-4 py-2 rounded-lg hover:bg-topol-600 transition-colors"
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-topol-500 focus:border-topol-500 persian-input"
                          required
                        />
                      </div>
                      <div>
                ...
                {menuItems.map((item) => (
                  <div key={item.id} className="glass-card rounded-lg overflow-hidden">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-topol-600 font-bold mb-2">
          ...
          {showScrollToTop && (
            <button
              onClick={scrollToTop}
              className="fixed bottom-6 left-6 z-[60] w-12 h-12 bg-topol-500 hover:bg-topol-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center animate-fade-in md:hidden"
