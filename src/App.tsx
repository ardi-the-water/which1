...
function App() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-topol-50 to-mopol-50 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-topol-50 to-mopol-50">
      <Header onAdminClick={() => setShowAdminLogin(true)} />
      
      <main className="container mx-auto px-1 md:px-4 py-6 md:py-8 max-w-full overflow-hidden">
